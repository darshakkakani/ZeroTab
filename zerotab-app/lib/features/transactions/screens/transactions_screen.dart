...
const _allCats = [
  ...
  _CatMeta('fuel',          'Fuel',           AppColors.gold),
  _CatMeta('utilities',     'Utilities',      AppColors.accent2),
  _CatMeta('transport',     'Transport',      AppColors.teal),
  _CatMeta('entertainment', 'Entertainment',  AppColors.coral),
  _CatMeta('health',        'Health',         AppColors.teal),
  _CatMeta('investment',    'Investment',     AppColors.teal),
  _CatMeta('subscriptions', 'Subscriptions',  AppColors.dataETF),
